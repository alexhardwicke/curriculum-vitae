...
\section{Arbetserfarenhet}
    \cventry{okt. 2014\\-- nu}{Systemutvecklare}{Erisma}{Malmö, Sverige}{}{
        \begin{itemize}% \itemsep -2pt % reduce space between items
            ...
            \item Förbättrade utvecklarmiljön i företaget, genom att bland annat lägga till stöd for felspårning i alla Erismas produkter, att migrera från .NET 3.5 till .NET 4.5 och att börja använda git istället för Mercurial.
...
\section{Egna projekt}
    \cventry{sep. 2015\\-- nu}{Boswell}{Hemsida \& bibliotek}{}{\Fsh{}}{
        \begin{itemize}% \itemsep -2pt % reduce space between items
            \item Felspårningssystem för UWP appar.
            \item Skrivit helt i \Fsh{} med WebSharper.
            \item Open source. Koden finns på: \url{https://github.com/alexhardwicke/boswell} \newline
        \end{itemize}
    }
